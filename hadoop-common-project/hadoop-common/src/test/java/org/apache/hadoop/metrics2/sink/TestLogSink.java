...
public class TestLogSink {
  ...
  protected final static File TEST_DIR = GenericTestUtils.getTestDir();
  ...
  public static void setUpClass() throws Exception {
    // Add the test configuration directory to the classpath.
    URLClassLoader urlClassLoader =
        (URLClassLoader) ClassLoader.getSystemClassLoader();
    Class<URLClassLoader> uclass = URLClassLoader.class;
    Method method = uclass.getDeclaredMethod("addURL", new Class[]{URL.class});
    method.setAccessible(true);
    method.invoke(urlClassLoader, new Object[]{TEST_DIR.toURI().toURL()});
  }
  ...
  public void setUp() throws IOException {
    ...
    this.configFile = new File(TEST_DIR,
